...
if (
    ...
    if (
        ...
        $articleC->modifierArticle($article, $_POST["reference"]);
...
<html class="no-js" lang="en">
	...
	<body>
		...
		<!--welcome-hero end -->
    <!-- Navbar End -->
    <button><a href="article.php">Retour à la liste des articles</a></button>
    <hr>
    ...
    if (isset($_POST['reference '])) {
        $article = $articleC->recupererarticle($_POST['reference']);
        ...
        <table border="1" align="center">
            <tr>
				...
				<tr>
                   ...
                   <td> <input type="text" name="name" id="name" title="Saisir un nom de produit" required> </td>
