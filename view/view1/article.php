...
<html class="no-js" lang="en">
    ...
    <div class="container" >											
			<button class="btn-cart welcome-add-cart " style="displayjustify-content: center;" onclick="window.location.href=' ajouterArticle.php'">ajouter  article</button>
</div>
<div class="container" >											
			<button class="btn-cart welcome-add-cart " style="displayjustify-content: center;" onclick="window.location.href='supprimerArticle.php'">supprimer article</button>
</div>
<div class="container" >											
			<button class="btn-cart welcome-add-cart " style="displayjustify-content: center;" onclick="window.location.href='afficherListeArticle.php'">afficher article</button>
</div>
<div class="container" >											
			<button class="btn-cart welcome-add-cart " style="displayjustify-content: center;" onclick="window.location.href='modifierArticle.php'">modifier article </button>
</div>
