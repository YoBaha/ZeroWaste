...
<html class="no-js" lang="en">
	...
	<body>
				        ...
				        <div class="container">            
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
									...
									<li class="scroll"><a href="index.php">categories</a></li>
				                </ul><!--/.nav -->
				            </div><!-- /.navbar-collapse -->
				        </div><!--/.container-->
				    </nav><!--/nav-->
		...
		<!-- clients end -->
		<div class="container" >											
			<button class="btn-cart welcome-add-cart " style="displayjustify-content: center;" onclick="window.location.href='article.php'">article</button>
</div>
		<!--newsletter strat -->
