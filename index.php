											...
											<div class="single-welcome-hero">
												<div class="welcome-hero-txt">
													...
													<button class="btn-cart welcome-add-cart" onclick="window.location.href='#'">
														...
														Our <span>Recycled</span> Products
													</button>
				        ...
				        <div class="container">            
				            ...
				            <div class="attr-nav">
				                <ul>
									...
									<li class="dropdown">
    <a href="mycart.php" class="dropdown-toggle" data-toggle="dropdown">
        <span class="lnr lnr-cart"></span>
		<span class="badge badge-bg-1" id="cart-count">*</span>
...
<li class="scroll"><a href="mycart.php">Mes Commandes</a></li>
										...
										<div class="col-md-8 col-sm-12">
											<div class="single-inner-populer-product-txt">
												...
												<div class="populer-products-price">
													<h4>Product Sales from <span>$1.00</span></h4>
												</div>
...
$sql = "SELECT ProductID, title, price, image FROM mycart";
$stmt = $db->prepare($sql);
$stmt->execute();
...
<div class="products-container">
  ...
  <?php endforeach; ?>
		...
		<!--blog end -->
		<div class="container" >											
			<button class="btn-cart welcome-add-cart " style="displayjustify-content: center;" onclick="window.location.href='reclamation.php'">Ajouter une reclamation</button>
</div>
