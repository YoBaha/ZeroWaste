...
<html lang="en">
<head>
    <?php include '../view/include/head_front.php' ?>
    <title>Panier</title>
</head>
<body>
<?php include '../view/include/nav_front.php' ?>
<div class="container py-2">
    ...
    if (isset($_POST['valider'])) {
        ...
        if ($inserted) {
            ...
            $_SESSION['panier'][$idUtilisateur] = [];
            header('location: ../view/panier.php?success=true&total=' . $total);
        } else {
            ?>
            ...
            if (empty($panier)) {
                if (!isset($_GET['success'])) {
                    ...
                    <div class="alert alert-warning" role="alert">
                        ...
                        Commençez vos achats <a class="btn btn-success btn-sm" href="../view/index.php">Acheter des
                            produits</a>
                    </div>
                    <?php
                }
